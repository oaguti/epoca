...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
    $menu = $_POST['menu'];
    $rutamini = "images/promo/thumbs/";
    $rutabig = "images/promo/";
    $imagen = $_POST['imagen'];
    $estado = 1;
    $insertSQL = sprintf("INSERT INTO promo (rutamini,rutabig,archivo,estado) VALUES (%s, %s, %s, %s)",
    ...
    echo '<script type="text/javascript">$(".mensaje").html("Promocion guardada")</script>';
} 
/////////////////////////////////////////
?>
<section id="page">
<script type="text/javascript" src="js/subida.js"></script>
<h1>Agregar una promocion</h1><br/>
<p class="mensaje"></p>
<div class="contener">
    ...
    <form action="" method="post" name="formOperaciones" id="carga_img" >
        ...
        <span id="msj"></span>
        <input type="submit" value="Subir al servidor" onClick ="enviar('promo'); return false;" class="bt_subir"  />
    </form>
</div>
