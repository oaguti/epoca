...
function carga_imagen ($img,$nombre){
    $archivos_disp_ar = array('jpg', 'gif');
  ...
  if(in_array($extension, $archivos_disp_ar)){
    ...
    ////// CREACION THUMBS /////////
    $carpeta = "img/contenido/mini";
    $img_original = imagecreatefromjpeg($nuevo_mini_carpeta);
	$max_ancho = 200;
	$max_alto = 150;
	
	list($ancho,$alto)=getimagesize($nuevo_mini_carpeta);
